...
[![GitHub release](https://img.shields.io/github/release/step-security/metadata-action.svg?style=flat-square)](https://github.com/step-security/metadata-action/releases/latest)
[![CI workflow](https://img.shields.io/github/actions/workflow/status/step-security/metadata-action/ci.yml?branch=master&label=ci&logo=github&style=flat-square)](https://github.com/step-security/metadata-action/actions?workflow=ci)
[![Test workflow](https://img.shields.io/github/actions/workflow/status/step-security/metadata-action/test.yml?branch=master&label=test&logo=github&style=flat-square)](https://github.com/step-security/metadata-action/actions?workflow=test)

## About

GitHub Action to extract metadata from Git reference and GitHub events. This action
is particularly useful if used with [Docker Build Push](https://github.com/step-security/docker-build-push-action)
...
So it can be used with our [Docker Build Push action](https://github.com/step-security/docker-build-push-action/):
...
> More context in [#192](https://github.com/step-security/metadata-action/pull/192#discussion_r854673012). 
...
With the [`build-push-action`](https://github.com/step-security/docker-build-push-action/),
